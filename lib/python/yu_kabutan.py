...
class yu_kabutan(yu.web):
  ...
  def round_up_price(self, price, is_topix100):
    ...
    price_ranges = [
        ...
        (30000, 50000, 50, 10),
        (50000, 100000, 100, 10),
        (100000, 300000, 100, 50),
        (300000, 500000, 500, 100),
        (500000, 1000000, 1000, 100),
        (1000000, 3000000, 1000, 500),
        (3000000, 5000000, 5000, 1000),
        (5000000, 10000000, 10000, 1000),
        (10000000, 30000000, 10000, 5000),
        (30000000, 50000000, 50000, 10000),
        (50000000, float('inf'), 100000, 10000)
    ]
